...
public class SubscriberSurfaceView extends SurfaceView {
    public int media_width = 320;
    public int media_height = 240;

    public SubscriberSurfaceView(Context context, AttributeSet attrs,
                                int defStyle) {
    ...
    public SubscriberSurfaceView(Context context) {
        super(context);
    }
