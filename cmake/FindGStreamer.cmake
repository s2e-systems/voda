set(GStreamer_RootSearchPath
    ""
    CACHE PATH "Additional root path to search GStreamer")
...
if(UNIX)
  ...
  pkg_check_modules(PkgConfig_video gstreamer-video-1.0)
endif()

# gstreamer
find_path(
  GStreamer_gstreamer_INCLUDE_DIR
  NAMES gst/gst.h
  PATHS ${GStreamer_ROOT_SEARCH_PATHS} ${PkgConfig_gstreamer_INCLUDE_DIRS}
  PATH_SUFFIXES include/gstreamer-1.0)
find_path(
  GStreamer_gstreamerConfig_INCLUDE_DIR
...
set(GStreamer_gstreamer_INCLUDE_DIRS ${GStreamer_gstreamer_INCLUDE_DIR}
                                     ${GStreamer_gstreamerConfig_INCLUDE_DIR})
...
find_path(
  ...
  PATH_SUFFIXES include/gstreamer-1.0)
find_path(
  GStreamer_glConfig_INCLUDE_DIR
  NAMES gst/gl/gstglconfig.h
  PATHS ${GStreamer_ROOT_SEARCH_PATHS} ${PkgConfig_gl_INCLUDE_DIRS}
  PATH_SUFFIXES lib/gstreamer-1.0/include include/gstreamer-1.0)
set(GStreamer_gl_INCLUDE_DIRS ${GStreamer_gl_INCLUDE_DIR}
                              ${GStreamer_glConfig_INCLUDE_DIR})
...
if(NOT TARGET GStreamer::GStreamer)
  ...
  set_target_properties(
    GStreamer::gstreamer
    PROPERTIES IMPORTED_LOCATION "${GStreamer_gstreamer_LIBRARY}"
               INTERFACE_INCLUDE_DIRECTORIES
               "${GStreamer_gstreamer_INCLUDE_DIRS}")
  ...
  set_target_properties(
    GStreamer::gl
    PROPERTIES IMPORTED_LOCATION "${GStreamer_gl_LIBRARY}"
